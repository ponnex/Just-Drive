...
public class Notification extends BroadcastReceiver {
    ...
    private String TAG = "com.ponnex.justdrive.Notification";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        context.stopService(new Intent(context, CallerService.class));
    ...
    public void cancellable(Boolean message) {
        Intent intent = new Intent("com.ponnex.justdrive.Notification");
        if (message != null) {
